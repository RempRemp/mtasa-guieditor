--[[--------------------------------------------------
	...
	shamelessly taken from dxscoreboard (originally taken from the map editor)
...
colorPicker = {
	...
	constructor = function( info )
		...
		colorPicker.GUI.selectWindow = guiCreateWindow((screenW - info.selectWindow.width) / 2, (screenH - info.selectWindow.height) / 2,
		                                        info.selectWindow.width, info.selectWindow.height, "Pick a colour", false)
		guiSetVisible(colorPicker.GUI.selectWindow, false)
		guiWindowSetSizable(colorPicker.GUI.selectWindow, false)
		
		guiWindowTitlebarButtonAdd(colorPicker.GUI.selectWindow, "Close", "right", function() colorPicker.closeSelect(true) end)
		guiWindowTitlebarButtonAdd(colorPicker.GUI.selectWindow, "Save", "left", function() colorPicker.closeSelect() end)

		colorPicker.GUI.palette = guiCreateStaticImage(colorPicker.selectWindow.paletteX, colorPicker.selectWindow.paletteY,
		                                        256, 256, "client/colorpicker/palette.png", false, colorPicker.GUI.selectWindow)
		colorPicker.GUI.alphaBar = guiCreateStaticImage(colorPicker.selectWindow.paletteX + 255 + colorPicker.selectWindow.alphaOffset, colorPicker.selectWindow.paletteY,
		                                         colorPicker.selectWindow.alphaWidth, 255, "client/colorpicker/alpha.png", false, colorPicker.GUI.selectWindow)
		...
		doOnChildren(colorPicker.GUI.selectWindow, setElementData, "guieditor.internal:noLoad", true)
	end,
	...
	openSelect = function( onClose, ... )
		if not colorPicker.GUI or not colorPicker.GUI.selectWindow then
			colorPicker.constructor()
		end
		
		if colorPicker.isSelectOpen then 
			ContextBar.add("The colour picker is already being used")
			return 
		end
	...
	focus = function()
		setCursorPosition ( guiElementGetScreenPosition(colorPicker.GUI.selectWindow) )
